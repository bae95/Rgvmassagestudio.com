...
exports.serializeArgsIntoCommandLine = exports.getProjectRoots = exports.parseFiles = exports.splitArgsIntoNxArgsAndOverrides = exports.names = void 0;
...
function splitArgsIntoNxArgsAndOverrides(args, mode, options = { printWarnings: true }, nxJson) {
    ...
    if (explicitOverrides) {
        ...
        overrides['__overrides_unparsed__'] = serializeArgsIntoCommandLine(overridesFromMainArgs);
    }
    if (mode === 'run-many') {
        if (!nxArgs.projects) {
            nxArgs.projects = [];
...
function serializeArgsIntoCommandLine(args) {
...
exports.serializeArgsIntoCommandLine = serializeArgsIntoCommandLine;
